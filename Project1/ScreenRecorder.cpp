...
int ScreenRecorder::openDevice() throw() {
    ...
    for (int i = 0; i < pAVFormatContext->nb_streams; i++) {
        ...
        /*else if (audioFormatContext->streams[i]->codecpar->codec_type == AVMEDIA_TYPE_AUDIO) {  //TODO tolto perchè in fase di completamento
            AudioStreamIndx = i;
        }*/
    }
    ...
    /*if (AudioStreamIndx == -1) {
        cerr << "Error: unable to find audio stream index" << endl;   //TODO tolto perchè in fase di completamento
        exit(-2);
    }*/
...
int ScreenRecorder::initOutputFile() {
    ...
    avformat_alloc_output_context2(&outAVFormatContext, nullptr, nullptr, "..\\media\\output.mp4");
    if (outAVFormatContext == nullptr) {
        cerr << "Error in allocating AVFormatContext" << endl;
        exit(-4);
    }

    outputFormat = av_guess_format(nullptr, "..\\media\\output.mp4", nullptr);
